// @deprecated — This route is no longer used. Precedent search now goes through
// FastAPI via briefsApi.findPrecedents() in lib/api/briefs.ts. Kept for rollback only.
